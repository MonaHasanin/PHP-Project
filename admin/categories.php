  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
       ...
       <td><a class='btn btn-primary'href='editCategory.php?id={$row['cust_id']}'>Update </a></td>
       <td><a class='btn btn-primary'href='deleteCategory.php?id={$row['cust_id']}'>Delete </a></td>
        </tr>";
        }
  ?>
