...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO beverages( title, Content, Price, active, Image, category_name) VALUES (?, ?, ?,?, ?,?)";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$title, $Content ,$Price , $active , $Image, $category_name]);
}	 
?>
<!DOCTYPE html>
<html lang="en">
								...
								<div class="x_content">
									...
									<form  action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea name="Content"  id="content" name="content" required="required" class="form-control">Contents</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="price" class="col-form-label col-md-3 col-sm-3 label-align">Price <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input name="Price"  id="price" class="form-control" type="number" name="price" required="required">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="Image"    type="file" id="image" name="image" required="required" class="form-control">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="category_name" id="">
													<option  name="category_name" value=" ">Select Category</option>
